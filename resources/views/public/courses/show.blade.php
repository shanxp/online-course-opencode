...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white rounded-xl shadow-sm border overflow-hidden">
            @if($course->thumbnail)
                <img src="{{ Storage::url($course->thumbnail) }}" alt="{{ $course->title }}" class="w-full h-56 sm:h-72 object-cover">
            @else
                <div class="w-full h-56 sm:h-72 bg-gradient-to-br from-primary-100 to-purple-100 flex items-center justify-center">
